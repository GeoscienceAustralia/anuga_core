...
domain.set_name('infiltration') # Output name
...
#------------------------------------------------------------------------------
print 'Set up infiltration to test...'


from anuga.operators.infiltration_operator import Infiltration_operator

# create operator
op1 = Infiltration_operator(domain)
