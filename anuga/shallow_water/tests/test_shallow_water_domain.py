...
#         pprint.pprint(gauge_values[3])
    ...
    def test_bedslope_problem_second_order_two_steps(self):
        ...
        assert num.allclose(domain.recorded_min_timestep, 0.0344599003014)
        assert num.allclose(domain.recorded_max_timestep, 0.0389583450282)





        W_EX = [ 0.0139179 ,  0.02042942,  0.01387861,  0.02260567,  0.01411961,
        0.02257022,  0.01411876,  0.02257068,  0.01410918,  0.02261447,
        0.01499783,  0.02389845, -0.04251109, -0.02212912, -0.04251948,
       -0.02246733, -0.04255301, -0.02249248, -0.04255414, -0.02249256,
       -0.04255723, -0.02246484, -0.04249686, -0.0227994 , -0.0981469 ,
       -0.07963855, -0.09814612, -0.0796798 , -0.09814534, -0.07968191,
       -0.09814485, -0.07968181, -0.0981447 , -0.07968234, -0.09814709,
       -0.07965679, -0.1536881 , -0.13518635, -0.15367303, -0.13518816,
       -0.15367326, -0.13518799, -0.15367317, -0.13518781, -0.15367978,
       -0.13518708, -0.15369949, -0.13518601, -0.20998266, -0.19073703,
       -0.21026541, -0.19066381, -0.21024984, -0.19066528, -0.21024981,
       -0.19066604, -0.21027042, -0.19065307, -0.20996069, -0.19066892,
       -0.25756828, -0.24830925, -0.25621951, -0.24781358, -0.25622055,
       -0.24781919, -0.25622027, -0.24781961, -0.25623837, -0.24769688,
       -0.25474901, -0.24797932]
    ...
    def test_bedslope_problem_second_order_more_steps(self):
        ...
        W_EX = [-0.02695415, -0.01287006, -0.02818574, -0.01247623, -0.02768874,
       -0.01207144, -0.02730899, -0.01194022, -0.02711282, -0.0117616 ,
       -0.02738771, -0.01167069, -0.07749118, -0.06043846, -0.0769658 ,
       -0.06184802, -0.07744466, -0.06141224, -0.07709613, -0.06116766,
       -0.07718967, -0.06125268, -0.07747803, -0.06164894, -0.12285222,
       -0.10929421, -0.12384982, -0.10947707, -0.12469478, -0.10954611,
       -0.12449187, -0.10900107, -0.12404879, -0.1096133 , -0.12558555,
       -0.11038741, -0.15781682, -0.1476446 , -0.15947493, -0.1506577 ,
       -0.15901211, -0.15175708, -0.15914706, -0.15170165, -0.15922835,
       -0.1509616 , -0.15923876, -0.15357957, -0.20664662, -0.1958594 ,
       -0.2061699 , -0.19450922, -0.20595402, -0.19406777, -0.20433092,
       -0.19402095, -0.20641805, -0.19359282, -0.20288242, -0.19214276,
       -0.1369593 , -0.14305522, -0.13546369, -0.14427954, -0.13441821,
       -0.14337654, -0.13422527, -0.14243224, -0.13457848, -0.14463175,
       -0.13452416, -0.14353644]
        ...
        UH_EX = [ 0.00788645,  0.00390814,  0.00711958,  0.00404466,  0.00733421,
        0.00422702,  0.00752395,  0.00429491,  0.00761551,  0.00434995,
        0.00721727,  0.00411432,  0.01646569,  0.0130111 ,  0.01644551,
        0.01216501,  0.01615127,  0.01240563,  0.01643715,  0.01256101,
        0.01627185,  0.01241143,  0.01595907,  0.01183127,  0.03255793,
        0.02449605,  0.02992571,  0.02396898,  0.029099  ,  0.02421192,
        0.02948018,  0.02487591,  0.03004103,  0.0239476 ,  0.0276319 ,
        0.02260694,  0.07102764,  0.05530028,  0.06897196,  0.04924545,
        0.07002517,  0.04776964,  0.06975088,  0.04800971,  0.06988388,
        0.04914598,  0.06973173,  0.04401888,  0.08838727,  0.07422356,
        0.08963216,  0.07728281,  0.08883881,  0.07725803,  0.08950098,
        0.07783773,  0.0896763 ,  0.07812909,  0.09101014,  0.07680172,
        0.01997572,  0.05705228,  0.02600184,  0.05722906,  0.02536524,
        0.05605345,  0.02487505,  0.05552244,  0.02476363,  0.05634745,
        0.02588648,  0.07443149]
...
#       0.02160608,  0.04663725,  0.02174734,  0.04795559,  0.02281427,  0.05667111])
        ...
        VH_EX = [  3.24389373e-04,  -2.89562023e-04,  -1.88586166e-04,
        -2.42370868e-04,  -4.27203357e-05,  -1.59405924e-04,
         1.72058997e-05,  -1.89182601e-04,  -7.17849451e-05,
        -2.62512543e-04,  -1.15231624e-04,  -5.30330999e-05,
         1.65246942e-04,   1.01105926e-04,  -1.95515883e-04,
        -3.52171991e-04,  -2.11327789e-04,  -1.71195081e-04,
        -1.13571246e-04,  -1.21618757e-04,  -3.84072310e-05,
        -5.70630953e-05,   1.99377831e-04,   7.26507645e-05,
         1.21737397e-03,   5.00567549e-04,   1.33045862e-04,
        -2.54549210e-04,  -2.69891715e-04,  -2.75002067e-04,
        -2.25034310e-04,  -2.80881699e-04,  -3.83637499e-04,
        -6.64640436e-05,   7.35727068e-04,   7.18052339e-04,
         1.80525370e-03,   7.01677479e-04,   6.77099758e-04,
        -1.61819203e-05,   5.43704204e-04,  -3.72049950e-04,
         4.05465795e-04,  -2.63344137e-04,   5.19126755e-04,
        -6.09877824e-04,  -4.60754612e-04,   3.76429746e-04,
         2.84536503e-04,   1.59630418e-03,   3.76390114e-04,
         5.95421898e-04,   2.82457784e-04,   5.47244203e-04,
         3.84716877e-04,   7.71753954e-04,   2.31027297e-05,
         3.69328529e-04,  -1.01941489e-03,   2.97123648e-04,
        -1.50688255e-03,  -2.59013076e-03,  -2.47801719e-03,
        -1.62973032e-03,  -1.46144964e-03,  -1.15516385e-03,
        -1.53438382e-03,  -1.08374100e-03,  -1.69606444e-03,
         2.83600865e-04,   3.68792917e-03,  -1.84496742e-03]
...
if __name__ == "__main__":
    ...
    suite = unittest.makeSuite(Test_Shallow_Water, 'test_distribute_away_from_bed')
