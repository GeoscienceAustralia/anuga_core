...
cdef extern from "swDE_domain_cuda.c" nogil:
	struct domain:
...
def extrapolate_second_order_edge_sw(object domain_object):
	...
	with nogil:
		e = _cuda_extrapolate_second_order_edge_sw(&D)
...
def fix_negative_cells(object domain_object):
	...
	with nogil:
		num_negative_cells = _cuda_fix_negative_cells(&D)
