  ...
  for (k = 0; k < K; k++)
  {
    ...
    for (i = 0; i < 3; i++)
    {
      ...
      _openmp__flux_function_central(ql0, ql1, ql2, qr0, qr1, qr2,
                                     ...
                                     &edgeflux0, &edgeflux1, &edgeflux2, &max_speed_local, &pressure_flux,
                                     hc, hc_n, low_froude);
      ...
      if (D->edge_flux_type[ki] == 1)
      {
        ...
        if (D->riverwall_elevation[RiverWall_count - 1] > fmax(zc, zc_n))
        {
          ...
          _openmp__adjust_edgeflux_with_weir(&edgeflux0, &edgeflux1, &edgeflux2, h_left_tmp, h_right_tmp, g,
                                             weir_height, Qfactor,
...
#pragma omp parallel for private(k, k0, k1, k2, k3, k6, coord_index, i, \
                          dx1, dx2, dy1, dy2, dxv0, dxv1, dxv2, dyv0, dyv1, dyv2, \
                          dq0, dq1, dq2, area2, inv_area2, \
