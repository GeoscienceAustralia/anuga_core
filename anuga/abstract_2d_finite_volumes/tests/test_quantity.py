...
Parameters
    ...
    def test_set_values_from_ll_tif_file(self):
        ...
        import utm
        utm_east_ll, utm_north_ll, zone, _ = utm.from_latlon(lat_ll, lon_ll)
        utm_east_ur, utm_north_ur, zone, _ = utm.from_latlon(lat_ur, lon_ur)
        ...
        mesh4 = Generic_Domain(points, elements,
                               geo_reference=Geo_reference(56, x0, y0, hemisphere='southern'))
        mesh4.check_integrity()
    ...
    def skip_set_values_from_utm_tif_file(self):
