...
pip install wheel numpy==1.26 scipy gdal==3.4.1 matplotlib pytest cython netcdf4 matplotlib dill future gitpython pyproj pymetis pybind11 meshpy Pmw ipython utm affine mpi4py
