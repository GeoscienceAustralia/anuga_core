/*
  This is to test of Reduce with all choices of root process 
  independently of pypar.

  Adapted from http://mpi.deino.net/mpi_functions/MPI_Reduce.html

  Ole Moller Nielsen - 2009
*/
