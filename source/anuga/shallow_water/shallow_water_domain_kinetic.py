...
#Subversion keywords:
#
#$LastChangedDate: 2006-01-13 16:43:01 +1100 (Fri, 13 Jan 2006) $
#$LastChangedRevision: 2206 $
#$LastChangedBy: steve $
...
flux_function = flux_function_kinetic
...
def protect_against_infinitesimal_and_negative_heights_c(domain):
    ...
    protect(domain.minimum_allowed_height, domain.epsilon,
            wc, zc, xmomc, ymomc)
...
if compile.can_use_C_extension('shallow_water_kinetic_ext.c'):
    ...
    from shallow_water_kinetic_ext import rotate, assign_windfield_values
