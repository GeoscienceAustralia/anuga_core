...
class Test_riverwall_structure(unittest.TestCase):
    ...
    def create_domain(self, wallHeight, InitialOceanStage, InitialLandStage):
        ...
        # 05/05/2014 -- riverwalls only work with DE1
    ...
    def test_noflux_riverwall(self):
        ...
        domain=self.create_domain(wallHeight,InitialOceanStage, InitialLandStage) 
    ...
    def test_simpleflux_riverwall(self):
    ...
    def test_simpleflux_riverwall_with_Qfactor(self):
    ...
    def test_submergeflux_riverwall(self):
