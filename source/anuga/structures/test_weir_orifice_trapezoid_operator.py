...
class Test_weir_orifice_trapezoid_operator(unittest.TestCase):
    ...
    def test_weir_orifice_non_skew(self):
        """test_weir_orifice_non_skew
        
        This tests the test_weir_orifice routine with data obtained from HECRAS version 4.1.0 
        Q=10m3/s no tailwater
        """
    ...
    def test_weir_orifice_1(self):
        ...
        if verbose:
            ...
            print ('%s %.2f,%.2f,%.2f' %('HECRAS4.1.0 ', Q_expected, v_expected, d_expected))
