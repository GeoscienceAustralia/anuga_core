...
def sww2png(name_in, name_out,
            ...
            datum='WGS84',
            block_size=None):
    """Read SWW file and convert to a png image
    (.png)
    ...
    If reduction is given and it's an index, sww2png will output the quantity at that time-step. 
...
def sww2png_batch(basename_in, extra_name_out=None,
