/* ptinpoly.c - point in polygon inside/outside code.
   ...
   This code contains the following algorithms:
	...
	if a no preprocessing and nor extra storage is available use the 
	Crossings test.
	...
	if preprocessing and extra storage is available in abundance, use the
	Grid test, except for perhaps triangles.
*/
