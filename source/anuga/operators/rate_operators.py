"""
Environmental operators such as rainfall.
...
class Circular_rate_operator(Operator):
    """
    ...
    def __init__(self, domain, rate=0.0, center=None, radius=None, verbose=False):
        ...
        # It is possilbe that circle doesn't intersect with mesh (as can happen
        # for parallel runs
        assert len(self.exchange_indices) > 0
