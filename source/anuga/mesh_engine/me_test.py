...
import unittest
import anuga.mesh_engine.mesh_engine as triang
...
class triangTestCase(unittest.TestCase):
	...
	#pointattlist = [[],[],[],[]]
        ...
        data = triang.genMesh(points,seglist,holelist,regionlist,
                              pointattlist,segattlist,trilist, mode,test)
...
if __name__ == "__main__":
    ...
    suite = unittest.makeSuite(triangTestCase,'metest')
